...
const Student = () => {
    ...
    const inputTitle = ["學生名稱", "積分資料", "其他資料"];
    const placeholderTexts = ["請輸入學生名稱", "請輸入積分資料", "請輸入其他資料"];
    ...
    return(
        ...
        <div className="main_container">
            <div className="data_header">
                <p className="font32" >積分資料管理</p>
                <button onClick={handleButtonClick}>新增積分資料</button>
                {isPopupOpen && (
